...
// This create the thrust servo object
Servo thrust_servo;
  #define FORWARD_TRUE (measure_ultrasonic_distance(ULTRASONIC_TRIGGER_PIN_2, ULTRASONIC_ECHO_PIN_2) > 300)
  #define LEFT_TRUE (measure_ultrasonic_distance(ULTRASONIC_TRIGGER_PIN_4, ULTRASONIC_ECHO_PIN_4) > 300)
  #define RIGHT_TRUE (measure_ultrasonic_distance(ULTRASONIC_TRIGGER_PIN_3, ULTRASONIC_ECHO_PIN_3) > 300)
  
  if FORWARD_TRUE
  {
    thrust_servo.write(115);
  }
  else
  {
    if LEFT_TRUE
    {
      steering_servo.write(75); //left
    }
    else if (!LEFT_TRUE && RIGHT_TRUE)
    {
      steering_servo.write(135); //right
    }
    else
    {
